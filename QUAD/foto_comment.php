...
?>
<?php
if (isset($_POST['comment']) && isset($_POST['foto'])) {
    $q1=$db->query("insert into fotos_comments(commenter,date,comment,foto) values ('".$_SESSION['id']."','".date('d/m/Y')."','".$_POST['comment']."','".$_POST['foto']."')");
}
else {
    redir("index.php");
}
