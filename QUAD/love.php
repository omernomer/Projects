...
if (isset($_POST['snum'])) {
    ...
    $row2=$q2->fetch_assoc();
    if ($row1['rate']=="1") {
        $q2=$db->query("update shouts_rates set rate='5' where shout='".$_POST['snum']."' and rater='".$_SESSION['id']."'");
    ...
    elseif ($row1['rate']=="0") {
        $q3=$db->query("update shouts_rates set rate='1' where shout='".$_POST['snum']."' and rater='".$_SESSION['id']."'");
        echo '<div id="shout_comments" snum="'.$_POST['snum'].'"><img src="icons/comments.png"/><p>'.shouts_comments($_POST['snum']).'</p></div><div id="love_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_loves($_POST['snum']).'</p></div><div id="hate_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_hates($_POST['snum']).'</p></div>';
        if ($row2['shouter']==$_SESSION['id']) {echo '<div snum="'.$_POST['snum'].'" id="shout_del_btn">Remove</div>';}
    }
    elseif ($row1['rate']=="5") {
        $q4=$db->query("update shouts_rates set rate='1' where shout='".$_POST['snum']."' and rater='".$_SESSION['id']."'");
        echo '<div id="shout_comments" snum="'.$_POST['snum'].'"><img src="icons/comments.png"/><p>'.shouts_comments($_POST['snum']).'</p></div><div id="love_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_loves($_POST['snum']).'</p></div><div id="hate_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_hates($_POST['snum']).'</p></div>';
        if ($row2['shouter']==$_SESSION['id']) {echo '<div snum="'.$_POST['snum'].'" id="shout_del_btn">Remove</div>';}
    }
    else {
        $q5=$db->query("insert into shouts_rates(rater,rate,shout) values ('".$_SESSION['id']."','1','".$_POST['snum']."')") or die("errrr");
        echo '<div id="shout_comments" snum="'.$_POST['snum'].'"><img src="icons/comments.png"/><p>'.shouts_comments($_POST['snum']).'</p></div><div id="love_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_loves($_POST['snum']).'</p></div><div id="hate_btn" snum="'.$_POST['snum'].'"><img src="images/hearth.png"/><p>'.shouts_hates($_POST['snum']).'</p></div>';
        if ($row2['shouter']==$_SESSION['id']) {echo '<div snum="'.$_POST['snum'].'" id="shout_del_btn">Remove</div>';}
    }
}
