        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        <div id="tr"></div>
                        <p style="font-weight: bold; color:#cb7b3e">About Bronze Logistics</p>
                        <p>It is one of the most important companies in Kurdistan Region that has proved its existence through the deep impact ,which is left in the business domain. B.L.C (Bronze Logistic Company) is specialized to help and accomplish all the official documents of companies and investors in this region, by insuring the legal and administrative needs of their clients. Moreover, B.L.C releases Visas and Residency transactions for foreign individuals and foundations....</p>
                        <p id="readmore"><a href="aboutus.php">Read More</a></p>
                    </div>
                </div>
                <div id="row" style="height: auto;">
