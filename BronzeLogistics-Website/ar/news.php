        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus" style="<?php if ($row1['pic']!="") { echo  'background-image:url(\'news/'.$row1['pic'].'\');'; } ?> background-position:left; background-repeat: no-repeat;">
                        <div id="tr"></div>
                        ...
                        <p><a style="text-decoration: underline; font-size:10pt; color:#cb7b3e" href="v_news.php?id=<?php echo $row1['id']; ?>">أقرأ المزيد</a></p>                      
                    </div>
                </div>
                <?php
                }
