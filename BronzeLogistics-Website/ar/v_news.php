...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        ...
                        if ($row1['pic2']!="") {
                            echo '<a style="padding:5px;" href="news/'.$row1['pic2'].'" rel="lightbox[g]" title="TITLE"><img src="cp/thumb.php?src=/news/'.$row1['pic2'].'&w=100&h=100" /></a>';
                        }
                        if ($row1['pic3']!="") {
                            echo '<a style="padding:5px;" href="news/'.$row1['pic3'].'" rel="lightbox[g]" title="TITLE"><img src="cp/thumb.php?src=/news/'.$row1['pic3'].'&w=100&h=100" /></a>';
                        }
                        if ($row1['pic4']!="") {
                            echo '<a style="padding:5px;" href="news/'.$row1['pic4'].'" rel="lightbox[g]" title="TITLE"><img src="cp/thumb.php?src=/news/'.$row1['pic4'].'&w=100&h=100" /></a>';
                        }
                        echo '</div>';
                        if ($row1['vid']!="") {
        ...
        $(window).load(function() {
            ...
            $("#menu li:contains('الأخبار')").css(css);
        });
        </script>
    </body>
</html>
