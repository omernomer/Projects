            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        ...
                        ?>
                            <label style="color: #fff;">كلمة السر الحالية</label>
                            <input type="password" name="cp" />
                            <label style="color: #fff;">كلمة السر الجديدة</label>
                            <input type="password" name="p1" />
                            <label style="color: #fff;">تأكيد كلمة السر</label>
                            <input type="password" name="p2" />
                            <label></label>
                            <input value="تحديث" type="submit" />
                        </form>                        
                    </div>
                </div>
