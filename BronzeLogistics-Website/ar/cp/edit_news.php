                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        ...
                        <p style="font-weight: bold; color:#cb7b3e">Adding News:</p>
                            ...
                            <label style="color: #ffffff;">العنوان</label>
                            <input required="required" name="title" value="<?php echo $row2['title']; ?>" type="text" />
                            <label style="color: #ffffff;">الخبر</label>
                            <textarea required="required" name="news"><?php echo $row2['news']; ?></textarea>
                            <label style="color: #ffffff;">الصورة</label>
                            <input name="pic" type="file" />
                            <label style="color: #ffffff;">2الصورة</label>
                            <input name="pic2" type="file" />
                            <label style="color: #ffffff;">3الصورة</label>
                            <input name="pic3" type="file" />
                            <label style="color: #ffffff;">4الصورة</label>
                            <input name="pic4" type="file" />
                            
                            <label style="color: #ffffff;">فيديو</label>
                            <input name="vid" type="file" />
                            <label></label>
                            <?php if ($row2['pic']!="") { echo '<img width="150" src="../news/'.$row2['pic'].'" /><a style="color: white;" href="del_news_img.php?id='.$row2['id'].'">Delete Image</a>'; } ?>
                            <label></label>
                            <?php if ($row2['pic2']!="") { echo '<img width="150" src="../news/'.$row2['pic2'].'" /><a style="color: white;" href="del_news_img2.php?id='.$row2['id'].'">Delete Image</a>'; } ?>
                            <label></label>
                            <?php if ($row2['pic3']!="") { echo '<img width="150" src="../news/'.$row2['pic3'].'" /><a style="color: white;" href="del_news_img3.php?id='.$row2['id'].'">Delete Image</a>'; } ?>
                            <label></label>
                            <?php if ($row2['pic4']!="") { echo '<img width="150" src="../news/'.$row2['pic4'].'" /><a style="color: white;" href="del_news_img4.php?id='.$row2['id'].'">Delete Image</a>'; } ?>
                            
                            <label></label>
                            <?php if ($row2['vid']!="") { echo '<a style="color: white;" href="del_news_vid.php?id='.$row2['id'].'">Delete Video</a>'; } ?>
                            <label></label>
