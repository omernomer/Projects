        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        <div id="tr"></div>
                        <p style="font-weight: bold; color:#cb7b3e">أدخال الأخبار:</p>
                        
                            <form class="formee" method="post" action="add_news_do.php" enctype="multipart/form-data">
                            <label style="color: #ffffff;">العنوان</label>
                            <input required="required" name="title" type="text" />
                            <label style="color: #ffffff;">الخبر</label>
                            <textarea required="required" name="news"></textarea>
