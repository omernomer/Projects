        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="row" style="height: auto;">
                    <div id="aboutus">
                        <div id="tr"></div>
                        <p style="font-weight: bold; color:#cb7b3e">Adding Customer:</p>
                            <form class="formee" method="post" action="add_cust_do.php" enctype="multipart/form-data">
                            <label style="color: #ffffff;">Customer Name</label>
                            <input required="required" name="name" type="text" />
                            <label style="color: #ffffff;">Picture (The picture must be "100px X 100px" and the background white)</label>
